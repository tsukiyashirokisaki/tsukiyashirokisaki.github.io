...
const experience = [
    { src: aics_logo, title: "AICS Big Data Engineer", description: "Construct automation-test pipelines and make front-end features.", time:"2023/09~now"},
    { src: yahoo_logo, title: "Search & Ads Intern", description: "Build up a hot spot extraction system.", time:"2022/07~2022/08" },
